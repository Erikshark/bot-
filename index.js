...
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈𝐋𝐈𝐍𝐊 」\`\`\`\n\n@${kice.split("@")[0]} ℎ𝑎 𝑠𝑖𝑑𝑜 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟𝑒𝑚𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑒𝑛 𝑒𝑠𝑡𝑒 𝑔𝑟𝑢𝑝𝑜`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
}
//anti travas
  ...
  replay(`\`\`\`「 𝐀𝐍𝐓𝐈-𝐓𝐑𝐀𝐕𝐀 」\`\`\`\n\n𝐿𝑜 𝑠𝑖𝑒𝑛𝑦𝑜 𝑤𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑘𝑢𝑎𝑘𝑒𝑟😠`)
...
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐘𝐓 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑒𝑛𝑙𝑎𝑐𝑒𝑠 𝑑𝑒 𝑦𝑜𝑢𝑡𝑢𝑏𝑒 𝑒𝑛 𝑒𝑠𝑡𝑒 𝑔𝑟𝑢𝑝𝑜😠`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//anti canal de yt
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐂𝐍𝐘𝐓 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑒𝑙 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑢𝑛 𝑐𝑎𝑛𝑎𝑙 𝑑𝑒 𝑦𝑜𝑢𝑡𝑢𝑏𝑒🙂`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink instagram
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐈𝐆 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑙 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑖𝑛𝑠𝑡𝑎𝑔𝑟𝑎𝑚🤨`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink fb
if (AntiLinkFacebook)
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐅𝐁 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑓𝑎𝑐𝑒𝑏𝑜𝑜𝑘 :v`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink telegram
if (AntiLinkTelegram)
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐓𝐆 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑡𝑒𝑙𝑒𝑔𝑟𝑎𝑚🤨`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink tiktok
if (AntiLinkTiktok)
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐓𝐊𝐓𝐊 」\`\`\`\n\n@${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑡𝑖𝑘𝑡𝑜𝑘🙂`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink twitter
if (AntiLinkTwitter)
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐓𝐖 」\`\`\`\n\n*[❗] @${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑢𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒 𝑑𝑒 𝑡𝑤𝑖𝑡𝑡𝑒𝑟 :'𝑣`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antilink all
if (AntiLinkAll)
...
kice = m.sender
await cnf.groupParticipantsUpdate(m.chat, [kice], 'remove')
cnf.sendMessage(from, {text:`\`\`\`「 𝐀𝐍𝐓𝐈-𝐀𝐋𝐋 」\`\`\`\n\n*[❗] @${kice.split("@")[0]} 𝑠𝑒𝑟𝑎𝑠 𝑒𝑥𝑝𝑢𝑙𝑠𝑎𝑑𝑜 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜 𝑝𝑜𝑟 𝑒𝑛𝑣𝑖𝑎𝑟 𝑢𝑛 𝑒𝑛𝑙𝑎𝑐𝑒`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
const buttonMessage = {image: {url: emoji.images[dua].url},caption: "𝐴𝑞𝑢𝑖 𝑡𝑖𝑒𝑛𝑒𝑠 :3",footerText: `${botname}`,buttons: buttons,headerType: 4}
...
${isWin ? `@${winner.split('@')[0]} 𝐺𝑎𝑛𝑜!` : isTie ? `Game Over` : `𝑇𝑢 𝑡𝑢𝑟𝑛𝑜 ${['❌', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`}
❌: @${room.game.playerX.split('@')[0]}
⭕: @${room.game.playerO.split('@')[0]}

𝐸𝑠𝑐𝑟𝑖𝑏𝑒 *rechazar* 𝑝𝑎𝑟𝑎 𝑟𝑒𝑛𝑑𝑖𝑟𝑡𝑒 𝑦 𝑎𝑑𝑚𝑖𝑡𝑖𝑟 𝑡𝑢 𝑑𝑒𝑟𝑜𝑡𝑎`
	    ...
	    cnf.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} 𝑅𝑒𝑐ℎ𝑎𝑧𝑜 𝑒𝑙 𝑗𝑢𝑒𝑔𝑜`, m)
	    ...
	    cnf.sendText(m.chat, `𝐸𝑙 𝑗𝑢𝑒𝑔𝑜 ℎ𝑎 𝑠𝑖𝑑𝑜 𝑒𝑛𝑣𝑖𝑎𝑑𝑜 𝑎𝑙 𝑝𝑟𝑖𝑣 𝑑𝑒 :
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) cnf.sendText(roof.p, `𝑃𝑜𝑟 𝑓𝑎𝑣𝑜𝑟 𝑠𝑒𝑙𝑒𝑐𝑖𝑜𝑛𝑎 \n\nRoca🗿\nPapel📄\nTijeras✂️`, m)
	    if (!roof.pilih2) cnf.sendText(roof.p2, `𝑃𝑜𝑟 𝑓𝑎𝑣𝑜𝑟 𝑠𝑒𝑙𝑒𝑐𝑖𝑜𝑛𝑎 \n\nRoca🗿\nPapel📄\nTijeras✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) cnf.sendText(m.chat, `𝐴𝑚𝑛𝑜𝑠 𝑗𝑢𝑔𝑎𝑑𝑜𝑟𝑒𝑠 𝑛𝑜 𝑞𝑢𝑖𝑒𝑟𝑒𝑛 𝑗𝑢𝑔𝑎𝑟 \n\n𝐽𝑈𝐸𝐺𝑂 𝐶𝐴𝑁𝐶𝐸𝐿𝐴𝐷𝑂`)
