...
console.log(color(`╚═══════════════════════════════════════════════════╝`, 'white'))
    ...
    cnf.sendMessage(callerId, { text: `*[❗] 𝑺𝑰𝑺𝑻𝑬𝑴𝑨 𝑫𝑬 𝑩𝑳𝑶𝑸𝑼𝑬𝑶 𝑨𝑼𝑻𝑶𝑴𝑨𝑻𝑰𝑪𝑶 [❗]*\n\n*¡𝐸𝑠𝑡𝑎 𝑝𝑟𝑜𝑖𝑏𝑖𝑑𝑜 𝑙𝑙𝑎𝑚𝑎𝑟 𝑎𝑙 𝑏𝑜𝑡 𝑠𝑒𝑟𝑎 𝑏𝑙𝑜𝑞𝑢𝑒𝑎𝑑𝑜!*\n𝑐𝑜𝑛𝑣𝑒𝑡𝑠𝑎 𝑐𝑜𝑛 𝑒𝑙 𝑐𝑟𝑒𝑎𝑑𝑜𝑟 𝑝𝑎𝑟𝑎 𝑡𝑢 𝑑𝑒𝑠𝑏𝑙𝑜𝑞𝑢𝑒𝑜!`}, { quoted : ffek })
    await sleep(8000)
    ...
    // Get Profile Picture Group
       ...
       cnf.send5ButImg(pea[0].id, `「 𝑨𝑱𝑼𝑺𝑻𝑬𝑺 」\n\n𝐸𝑙 𝑔𝑟𝑢𝑝𝑜 𝑎 𝑠𝑖𝑑𝑜 𝑐𝑒𝑟𝑟𝑎𝑑𝑜 𝑝𝑜𝑟 𝑒𝑙 𝑎𝑑𝑚𝑖𝑛, 𝑠𝑜𝑙𝑜 𝑙𝑜𝑠 𝑎𝑑𝑚𝑖𝑛𝑠 𝑝𝑜𝑑𝑟𝑎𝑛 𝑒𝑛𝑣𝑖𝑎𝑟 𝑚𝑒𝑛𝑠𝑠𝑗𝑒𝑠`, `${botname}`, lppgc, [])
       } else if(pea[0].announce == false) {
       cnf.send5ButImg(pea[0].id, `「 𝑨𝑱𝑼𝑺𝑻𝑬𝑺 」\n\n𝐸𝑙 𝑔𝑟𝑢𝑝𝑜 𝑎 𝑎𝑏𝑖𝑒𝑟𝑡𝑜, 𝑡𝑜𝑑𝑜𝑠 𝑝𝑢𝑒𝑑𝑒𝑛 𝑒𝑛𝑣𝑖𝑎𝑟 𝑚𝑒𝑛𝑠𝑎𝑗𝑒𝑠`, `${botname}`, lppgc, [])
       } else if (pea[0].restrict == true) {
       cnf.send5ButImg(pea[0].id, `「 𝑨𝑱𝑼𝑺𝑻𝑬𝑺 」\n\n𝐿𝑎 𝑖𝑛𝑓𝑜 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜 𝑎 𝑠𝑖𝑑𝑜 𝑟𝑒𝑠𝑡𝑟𝑖𝑛𝑔𝑖𝑑𝑎, 𝑠𝑜𝑙𝑜 𝑙𝑜𝑠 𝑎𝑑𝑚𝑖𝑛𝑠 𝑝𝑜𝑑𝑟𝑎𝑛 𝑒𝑑𝑖𝑡𝑎𝑟𝑙𝑎`, `${botname}`, lppgc, [])
       } else if (pea[0].restrict == false) {
       cnf.send5ButImg(pea[0].id, `「 𝑨𝑱𝑼𝑺𝑻𝑬𝑺 」\n\n𝑆𝑒 𝑎 𝑑𝑒𝑠𝑎𝑐𝑡𝑖𝑣𝑎𝑑𝑜 𝑙𝑎 𝑟𝑒𝑠𝑡𝑟𝑖𝑐𝑐𝑖𝑜𝑛 𝑑𝑒 𝑙𝑎 𝑖𝑛𝑓𝑜, 𝑡𝑜𝑑𝑜𝑠 𝑝𝑢𝑒𝑑𝑒 𝑒𝑖𝑡𝑎𝑟𝑙𝑎`, `${botname}`, lppgc, [])
       } else {
       cnf.send5ButImg(pea[0].id, `「 𝑨𝑱𝑼𝑺𝑻𝑬𝑺 」\n\n𝐸𝑙 𝑎𝑠𝑢𝑛𝑡𝑜 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜 𝑠𝑒 𝑎 𝑐𝑎𝑚𝑏𝑖𝑎𝑑𝑜 𝑎  *${pea[0].subject}*`, `${botname}`, lppgc, [])
     }
    })
...
title: `${ownername}`,
body: `𝑁𝑜 𝑜𝑙𝑣𝑖𝑑𝑒𝑠 𝑙𝑒𝑒𝑟 𝑙𝑎𝑠 𝑟𝑒𝑔𝑙𝑎𝑠 𝑑𝑒𝑙 𝑔𝑟𝑢𝑝𝑜!`,
mediaType:2,
thumbnail: welcomeft,
sourceUrl: `${websitex}`,
mediaUrl: `${websitex}`
